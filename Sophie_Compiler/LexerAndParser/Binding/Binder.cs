...
internal sealed class Binder
{
    ...
    private BoundExpression BindUnaryExpression(UnaryExpressionSyntax syntax)
    {
        ...
        var boundOperatorKind = BindUnaryOperatorKind(syntax.OperatorToken.SyntaxKind,boundOperand.Type);
    ...
    private BoundExpression BindBinaryExpression(BinaryExpressionSyntax syntax)
    {
        ...
        var boundOperatorKind = BindBinaryOperatorKind(syntax.OperatorToken.SyntaxKind,boundLeft.Type,boundRight.Type);
        if (boundOperatorKind == null)
        {
